...
public class SolvingFreeFormQuiz extends TestBase{
	DashboardPage homepageafterpageobject;
	FEAssignmentPage assignmentpageobject;
	AssessmentListPage assessmsntListpageobject;
    ...
    public void openassessment() throws InterruptedException 
	{
		...
		assessmsntListpageobject=new AssessmentListPage(driver);
		//assessmsntListpageobject.startquiz();
	...
	public void assessmentsolving() throws InterruptedException 
	{
		...
		assessmentquestionpageobject.solve_freeform_question();
		Thread.sleep(1000);
