...
public class MCQ_Editing extends TestBase {
    ...
    public void openassessment() throws InterruptedException 
	{
		...
		//assessmentlistpageobject.edit_MCQ_Assessment();
		...
		for(int i=1;i<=size;i++) 
		{
			try {
				...
				if(name.equalsIgnoreCase("mcq edit")) 
				{
	...
	public void assessmentsolving() throws InterruptedException 
	{
		...
		assessmentquestionpageobject.edit_MCQ_question();
		Thread.sleep(1000);
